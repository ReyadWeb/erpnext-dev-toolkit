...
**Current release:** v1.19.20-beta.3 (July 2026)
...
| Docker access + guided HTTPS + credentials parity | Beta (v1.19.20-beta.3; local VM and real VPS validation passed; final CI promotion pending) |
