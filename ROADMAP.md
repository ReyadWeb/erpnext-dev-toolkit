...
**Current release:** v1.19.20-beta.2 (July 2026)
...
| Docker access + guided HTTPS + credentials parity | Beta (v1.19.20-beta.2; local credential re-test + real VPS validation required) |
