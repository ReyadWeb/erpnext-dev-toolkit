...
toolkit_release_lib_files() {
  printf '%s\n' \
    ...
    dashboard.sh inventory.sh planner.sh removal.sh healing.sh menu.sh security.sh update.sh deployment_info.sh operations_api.sh backup_api.sh api.sh commands.sh
}
