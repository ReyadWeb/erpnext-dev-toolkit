...
show_command_audit() {
  ...
  status_line "Health monitoring" "OK" "dashboard, health-snapshot, incidents, health-history, health-metrics, health-monitoring-wizard, health-check, configure-health-check-timer, health-check-status, health-check-journal"
