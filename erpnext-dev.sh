...
update_toolkit() {
  require_sudo
  local url tmp lib_url lib_dest
  url="https://raw.githubusercontent.com/ReyadWeb/erpnext-dev-installer/main/erpnext-dev.sh?cache_bust=$(date +%s)"
  lib_url="https://raw.githubusercontent.com/ReyadWeb/erpnext-dev-installer/main/lib/common.sh?cache_bust=$(date +%s)"
  ...
  lib_dest="$(dirname "$INSTALLER_CANONICAL_PATH")/lib/common.sh"
