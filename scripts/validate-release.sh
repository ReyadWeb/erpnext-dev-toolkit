...
[[ -x scripts/test-existing-installation-adoption.sh ]] \
  || fail "scripts/test-existing-installation-adoption.sh is missing or not executable"
...
chmod +x scripts/test-existing-installation-adoption.sh
