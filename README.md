...
**Current release:** v1.20.0-beta.1 · **Readiness:** Debian 13 native acceptance passed for the responsive UI, Logs navigation, static-IP DNS persistence, HTTPS, backup/restore, reboot, and autostart. Combined beta CI and production regression validation remain pending; latest stable is v1.19.21.
