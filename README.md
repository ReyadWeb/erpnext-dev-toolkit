...
**Current release:** v1.19.21-beta.2 · **Readiness:** Docker production optional-app local-image deployment beta validation; latest stable is v1.19.20.
